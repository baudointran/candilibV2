...
// Trim nom et prenom avant enregistrement en base
CandidatSchema.pre('save', async function preSave () {
  const candidat = this
  candidat.nomNaissance = candidat.nomNaissance && candidat.nomNaissance.trim()
  candidat.prenom = candidat.prenom && candidat.prenom.trim()
})
